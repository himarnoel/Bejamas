    ...
    <div className="mb-10 lg:px-20 px-3">
      ...
      <div className="flex   mt-10">
        ...
        >
          <div
            className={
              " top-[0%]  duration-700 ease-in-out  lg:hidden h-[10%] w-full left-0 bg-black/[0.2]"
            }
          ></div>
          <div
            className={
          ...
          <div
            className={
              openUp
                ? " lg:hidden bottom-[0%] duration-700 ease-in-out h-[20%] flex justify-between items-center w-full left-0 px-10  bg-white border-t-2 text-[#E4E4E4] "
                : " hidden bottom-[-100%] duration-700 ease-in-out h-[20%]  justify-between items-center w-full left-0 px-10  bg-white border-t-2 text-[#E4E4E4] "
            }
          >
